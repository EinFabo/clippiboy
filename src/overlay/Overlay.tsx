  ...
  if (!banner) {
    ...
    return (
      <div className="flex h-full w-full items-start justify-end p-3">
        <div className="cb-rec flex items-center gap-2 rounded-inner px-3 py-1.5">
  ...
  return (
    <div className="flex h-full w-full items-center justify-center p-3">
      <div
        ...
        // Grund und Schatten stehen in `overlay.css` — siehe `.cb-card`.
        className={cn(
          "cb-card relative flex w-full items-center gap-3.5 rounded-card p-3",
          banner.kind === "error" && "cb-card-error",
        )}
      >
